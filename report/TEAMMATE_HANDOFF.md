...
- report: `report/gated_pre_asd_32stock_multiseed.md`
...
| cache | `data/cache/position_optiver_hf_second_feature_cache_32stocks_512t.npz` |
| train stocks | 31 stocks: `0-11, 13-23, 26-33` |
| zero-shot stock | `34` |
| patch preset | `short_second` |
| second | context `64`, patch `8`, stride `4` |
| minute | context `8`, patch `4`, stride `2` |
| hour | context `32`, patch `8`, stride `4` |
